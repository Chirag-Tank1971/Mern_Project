...
const addAgent = async (req, res) => {
  try {
    const { name, email, mobile, password } = req.body; // Extract agent details from request body
...
module.exports = { addAgent, getAgents, deleteAgent }; // Export the functions for use in routes
